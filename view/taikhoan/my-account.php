                    ...
                    <div class="tab-content myaccount-tab-content" id="account-page-tab-content">
                        <div class="tab-pane fade show active" id="account-dashboard" role="tabpanel"
                            ...
                            <div class="myaccount-dashboard">
                                <p>Xin chào <b>Edwin Adams</b> (không phải Edwin Adams? <a href="login-register.html" class="bosung1">Đăng xuất
                                        </a>)</p>
                                <p>Từ bảng điều khiển bạn có thể xem thông tin tài khoản, đơn hàng gần đây, quản lý
                                    địa chỉ giao hàng hoặc <a href="index.php?act=updateacc" class="bosung1">cập nhật thông tin tài khoản của bạn</a>.</p>
                            </div>
                        </div>
                                ...
                                <form action="#" class="kenne-form">
                                    <div class="kenne-form-inner">
                                        <div class="single-input single-input-half">
                                            <label for="account-details-firstname">Tên*</label>
                                            <input type="text" id="account-details-firstname">
                                        </div>
                                        <div class="single-input single-input-half">
                                            <label for="account-details-lastname">Họ*</label>
                                        ...
                                        <div class="single-input">
                                            <label for="account-details-oldpass">Mật khẩu hiện tại (Để chống hoặc không thay đổi)</label>
