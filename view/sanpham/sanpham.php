                            ...
                            <div class="single-product">
                                ...
                                <div class="product-content">
                                    <div class="product-desc_info">
                                        ...
                                        <h6 class="product-name"><a href="index.php?act=sanphamct">Quibusdam
                                                ratione</a></h6>
                                        <div class="rating-box">
                                            <ul>
                                                <li><i class="ion-ios-star"></i></li>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="product-item">
                            <div class="single-product">
                                ...
                                <div class="product-content">
                                    <div class="product-desc_info">
                                        <h3 class="product-name"><a href="index.php?act=sanphamct">Expedita excepturi</a>
                                        </h3>
                                        <div class="price-box">
                            ...
                            <div class="single-product">
                                ...
                                <div class="product-content">
                                    <div class="product-desc_info">
                                        ...
                                        <h6 class="product-name"><a href="index.php?act=sanphamct">Expedita excepturi</a>
                                        </h6>
                                        <div class="rating-box">
                                            <ul>
                                                <li><i class="ion-ios-star"></i></li>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="product-item">
                            <div class="single-product">
                                ...
                                <div class="product-content">
                                    <div class="product-desc_info">
                                        <h3 class="product-name"><a href="index.php?act=sanphamct">Recusandae fugit</a></h3>
                                        <div class="price-box">
                        ...
                        <div class="list-product_item">
                            <div class="single-product">
                                <div class="product-img">
                                    <a href="index.php?act=sanphamct">
                                        <img src="view/assets/images/product/4-2.jpg" alt="Kenne's Product Image">
                                    </a>
                                </div>
                                <div class="product-content">
                                    <div class="product-desc_info">
                                        ...
                                        <h6 class="product-name"><a href="index.php?act=sanphamct">Recusandae fugit</a></h6>
                                        <div class="rating-box">
                                            <ul>
                                                <li><i class="ion-ios-star"></i></li>
                                                <li><i class="ion-ios-star"></i></li>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="product-item">
                            <div class="single-product">
                                ...
                                <div class="product-content">
                                    <div class="product-desc_info">
                                        <h3 class="product-name"><a href="index.php?act=sanphamct">Facere molestias</a></h3>
                                        <div class="price-box">
                                            <span class="new-price">$80.00</span>
                        ...
                        <div class="list-product_item">
                            <div class="single-product">
                                <div class="product-img">
                                    <a href="index.php?act=sanphamct">
                                        <img src="view/assets/images/product/5-2.jpg" alt="Kenne's Product Image">
                                    </a>
                                </div>
                                <div class="product-content">
                                    <div class="product-desc_info">
                                        ...
                                        <h6 class="product-name"><a href="index.php?act=sanphamct">Facere molestias</a></h6>
                                        <div class="rating-box">
                                            <ul>
                                                <li><i class="ion-ios-star"></i></li>
                                                <li><i class="ion-ios-star"></i></li>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="product-item">
                            <div class="single-product">
                                ...
                                <div class="product-content">
                                    <div class="product-desc_info">
                                        <h3 class="product-name"><a href="index.php?act=sanphamct">Rem voluptate</a></h3>
                                        <div class="price-box">
                        ...
                        <div class="list-product_item">
                            <div class="single-product">
                                <div class="product-img">
                                    <a href="index.php?act=sanphamct">
                                        <img src="view/assets/images/product/6-2.jpg" alt="Kenne's Product Image">
                                    </a>
                                </div>
                                <div class="product-content">
                                    <div class="product-desc_info">
                                        ...
                                        <h6 class="product-name"><a href="index.php?act=sanphamct">Rem voluptate</a></h6>
                                        <div class="rating-box">
                                            <ul>
                                                <li><i class="ion-ios-star"></i></li>
                                                <li><i class="ion-ios-star"></i></li>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="product-item">
                            <div class="single-product">
                                ...
                                <div class="product-content">
                                    <div class="product-desc_info">
                                        <h3 class="product-name"><a href="index.php?act=sanphamct">Cumque nulla</a></h3>
                                        <div class="price-box">
                                            <span class="new-price">$46.91</span>
                                            <span class="old-price">$50.99</span>
                                        </div>
                        ...
                        <div class="list-product_item">
                            <div class="single-product">
                                <div class="product-img">
                                    <a href="index.php?act=sanphamct">
                                        <img src="view/assets/images/product/7-2.jpg" alt="Kenne's Product Image">
                                    </a>
                                </div>
                                <div class="product-content">
                                    <div class="product-desc_info">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                            ...
                            <div class="single-product">
                                ...
                                <div class="product-content">
                                    <div class="product-desc_info">
                                        ...
                                        <h3 class="product-name"><a href="index.php?act=sanphamct">Aliquid vitae</a></h3>
                                        <div class="rating-box">
                                            <ul>
                                                <li><i class="ion-ios-star"></i></li>
                                                <li><i class="ion-ios-star"></i></li>
                        ...
                        <div class="list-product_item">
                            <div class="single-product">
                                <div class="product-img">
                                    <a href="index.php?act=sanphamct">
                                        <img src="view/assets/images/product/8-2.jpg" alt="Kenne's Product Image">
                                    </a>
                                </div>
                                <div class="product-content">
                                    <div class="product-desc_info">
                                        ...
                                        <h6 class="product-name"><a href="index.php?act=sanphamct">Aliquid vitae</a></h6>
                                        <div class="rating-box">
                                            <ul>
                                                <li><i class="ion-ios-star"></i></li>
                                                <li><i class="ion-ios-star"></i></li>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6">
                        <div class="product-item">
                            <div class="single-product">
                                <div class="product-img">
                                    <a href="index.php?act=sanphamct">
                                        <img class="primary-img" src="view/assets/images/product/5-2.jpg"
                                            alt="Kenne's Product Image">
                                        <img class="secondary-img" src="view/assets/images/product/5-1.jpg"
                                            alt="Kenne's Product Image">
                                    </a>
                                    <span class="sticker-2">Hot</span>
                                    <div class="add-actions">
                                ...
                                <div class="product-content">
                                    <div class="product-desc_info">
                                        ...
                                        <h3 class="product-name"><a href="index.php?act=sanphamct">Assumenda delectus</a>
                                        </h3>
                                        <div class="rating-box">
                                            <ul>
                                                <li><i class="ion-ios-star"></i></li>
                        ...
                        <div class="list-product_item">
                            <div class="single-product">
                                <div class="product-img">
                                    <a href="index.php?act=sanphamct">
                                        <img src="view/assets/images/product/5-1.jpg" alt="Kenne's Product Image">
                                    </a>
                                </div>
                                <div class="product-content">
                                    <div class="product-desc_info">
                                        ...
                                        <h6 class="product-name"><a href="index.php?act=sanphamct">Assumenda delectus</a>
                                        </h6>
                                        <div class="rating-box">
                                            <ul>
                                                <li><i class="ion-ios-star"></i></li>
